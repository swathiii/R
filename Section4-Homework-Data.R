...
Free.Throw.Attempts <- rbind(KobeBryant_FTA, JoeJohnson_FTA, LeBronJames_FTA, CarmeloAnthony_FTA,
                             DwightHoward_FTA, ChrisBosh_FTA, ChrisPaul_FTA,
                             KevinDurant_FTA, DerrickRose_FTA, DwayneWade_FTA)
rownames(Free.Throw.Attempts)<- Players 
colnames(Free.Throw.Attempts)<- Seasons
...
plotfunc(Free.Throw.Attempts/Games)

#accuracy of FT 
Free.Throws/Free.Throw.Attempts
plotfunc(Free.Throws/Free.Throw.Attempts)

#Player playing style (2 vs 3 points preference) excluding Free Throws*
#*Each Free Throw is worth 1 point

#Points - Free.Throws / FieldGoals

Points
Free.Throws
FieldGoals

Stylepoint <- Points - Free.Throws
Stylepoint
plotfunc(Stylepoint)

#Answer : 

Stylepoint / FieldGoals
plotfunc(Stylepoint / FieldGoals)
